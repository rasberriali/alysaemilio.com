      ...
      <div className="flex flex-row  xl:gap-3 gap-4  items-center">
        ...
        <div className="flex-1 flex-row justify-between items-start ">
          <div className="flex flex-col justify-center xl:space-y-3 space-y-2">
            ...
            <h1 className="xl:text-2xl  font-bold tracking-wide">
              Alysa Emilio
            </h1>
            ...
            <div className="flex flex-row py-2 gap-2 px-2 bg-blue-400 text-center justify-center items-center rounded-[5px]">
                <img src={email} alt="" className="w-4"></img>

                <div className="xl:text-sm text-xs font-medium text-white">
                    Send Email
                </div>
            </div>
                
                 <div className="flex flex-row py-2 px-2 gap-2 ring ring-blue-100 text-center justify-center items-center rounded-[5px]">
